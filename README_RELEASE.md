# LMA Studio v0.2.1 Release Notes

LMA Studio is a local desktop application for project-based, human-assisted LIF-MS annotation review.

## Downloads

- `LMA-Studio-v0.2.1-windows-x64.zip`: fully validated Windows x64 build. Keep the extracted folder together and run `LMAStudio.exe`.
- `LMA-Studio-v0.2.1-macos-arm64.zip`: Apple Silicon candidate built and structurally verified on GitHub Actions. Open `LMA Studio.app`.
...
- Windows runtime configuration and a downloaded-file-marker regression probe prevent pythonnet startup failures after extracting a GitHub download.
