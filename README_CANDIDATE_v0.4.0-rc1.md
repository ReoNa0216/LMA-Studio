...
This earlier candidate is retained only as a historical record. Do not use it for current HSC1 acceptance. Use `README_CANDIDATE_v0.4.0-rc4.md` and `docs/HSC1_v0.4.0-rc4_UAT.md` instead.
