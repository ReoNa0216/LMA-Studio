...
The current formal release is v0.4.7. Existing v0.4.0-v0.4.6 projects using the current peak-recognition standard remain manifest-compatible and are not migrated when opened.
...
```bash
LMA_STUDIO_VERSION=v0.4.7 bash packaging/macos/build_macos.sh
```
